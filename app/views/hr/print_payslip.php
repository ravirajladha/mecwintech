...
$od_days = 0;
$sunday_days = 0;
$begin1 = new DateTime("2022-07-01");
$end1   = new DateTime("2022-07-31");
	...
	<?php $salary_detail = $model->get_salary($employee->mec_id);
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header center"><p style="text-align:center;"> Payslip for the month ofJuly, 2020</p></div>
                    <div class="card-body">
                        <div class="row mb-5">
