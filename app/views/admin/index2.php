							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header border-0 pb-0 flex-wrap">
										...
										<div class="custom-control custom-switch toggle-switch text-end me-3 mb-2">
										...
										<div class="dropdown custom-dropdown mb-0 mt-3 mt-sm-0 mb-2">
											<div class="btn border text-black btn-rounded" role="button" data-bs-toggle="dropdown" aria-expanded="false">
												This Month
												<i class="las la-angle-down scale5 text-primary ms-3"></i>
											</div>
											<div class="dropdown-menu dropdown-menu-end">
