				...
				<div class="row">
					<div class="col-xl-6">
						<div class="row">
									...
									<div class="card-body pb-4">
										<div class="row">
											...
											<div class="col-xl-5 col-md-5 p-md-0">
												<h6 class="fs-16 text-black mb-4">Legend</h6>
												<div class="d-flex mb-3 align-items-center">
													<svg class="me-3 min-w32" width="32" height="23" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
														<rect width="32" height="23" rx="11.5" fill="#2BC155"/>
													</svg>
													<span class="fs-18 text-black me-3 font-w600">30%</span>
												...
												<div class="d-flex mb-3 align-items-center">
													<svg class="me-3 min-w32" width="32" height="23" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
														<rect width="32" height="23" rx="11.5" fill="#3F9AE0"/>
													</svg>
													<span class="fs-18 text-black me-3 font-w600">14%</span>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header align-items-center flex-wrap border-0 pb-0">
										<h4 class="fs-20 text-black mb-2 me-3">Visitor Graph</h4>
									...
									<div class="card-body">
										...
										<div class="d-flex align-items-center">
											<svg class="min-w42 me-3 primary-icon" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<path d="M21 26.25C23.8995 26.25 26.25 23.8995 26.25 21C26.25 18.1005 23.8995 15.75 21 15.75C18.1005 15.75 15.75 18.1005 15.75 21C15.75 23.8995 18.1005 26.25 21 26.25Z" fill="#40189D"/>
											</svg>
											<div>
									...
									<div class="card-body">
										...
										<div class="d-flex align-items-center">
											<svg class="min-w42 me-3" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
												...
												<path d="M38.4998 10.4995H35.0002V38.4998H38.4998C40.4245 38.4998 42 36.9238 42 34.9991V13.9991C42 12.075 40.4245 10.4995 38.4998 10.4995Z" fill="#2BC155"/>
												<path d="M27.9998 10.4995V6.9998C27.9998 5.07515 26.4243 3.49963 24.5001 3.49963H17.4998C15.5756 3.49963 14.0001 5.07515 14.0001 6.9998V10.4995H10.5V38.4998H31.5V10.4995H27.9998ZM24.5001 10.4995H17.4998V6.99929H24.5001V10.4995Z" fill="#2BC155"/>
												<path d="M3.50017 10.4995C1.57551 10.4995 0 12.075 0 13.9996V34.9996C0 36.9243 1.57551 38.5003 3.50017 38.5003H6.99983V10.4995H3.50017Z" fill="#2BC155"/>
												</g>
												<defs>
												<clipPath id="clip0">
										...
										<div class="row sp10">
											<div class="col-xl-3 col-xxl-6 col-md-3 col-6 mb-4 text-center">
												<div class="d-inline-block ms-auto me-auto mb-2 relative donut-chart-sale me-4">
													<span class="donut2" data-peity='{ "fill": ["rgb(64, 24, 157)", "rgba(239, 239, 239, 1)"],   "innerRadius": 38, "radius": 10}'>6/9</span>
											...
											<div class="col-xl-3 col-xxl-6 col-md-3 col-6 mb-4 text-center">
												<div class="d-inline-block ms-auto me-auto mb-2 relative donut-chart-sale me-4">
													<span class="donut2" data-peity='{ "fill": ["rgb(64, 24, 157)", "rgba(239, 239, 239, 1)"],   "innerRadius": 38, "radius": 10}'>3/9</span>
											...
											<div class="col-xl-3 col-xxl-6 col-md-3 col-6 mb-4 text-center">
												<div class="d-inline-block ms-auto me-auto mb-2 relative donut-chart-sale me-4">
													<span class="donut2" data-peity='{ "fill": ["rgb(64, 24, 157)", "rgba(239, 239, 239, 1)"],   "innerRadius": 38, "radius": 10}'>6/8</span>
											...
											<div class="col-xl-3 col-xxl-6 col-md-3 col-6 mb-4 text-center">
												<div class="d-inline-block ms-auto me-auto mb-2 relative donut-chart-sale me-4">
													<span class="donut2" data-peity='{ "fill": ["rgb(64, 24, 157)", "rgba(239, 239, 239, 1)"],   "innerRadius": 38, "radius": 10}'>7/10</span>
