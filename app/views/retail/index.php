...
<head>
    ...
    <!-- Favicons Icon -->
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo URLROOT; ?>/assets_retail/images/favicon.png" />
...
<div class="page-wraper">
		...
		<div class="main-bar">
			<div class="container">
				<div class="header-content">
                    ...
                    <img src="<?php echo URLROOT; ?>/<?php echo URLROOT; ?>/assets_retail/logo.png" width="125">
				</div>
			</div>
		</div>
	</header>
    ...
    <div class="sidebar">
		<div class="author-box">
			<div class="dz-media">
				<img src="<?php echo URLROOT; ?>/assets_retail/images/author/pic1.png" class="rounded-circle" alt="author-image">
			</div>
			<div class="dz-info">
	...
	<div class="banner-wrapper author-notification">
		<div class="container inner-wrapper">
			...
			<div class="dz-media media-45 rounded-circle">
				<a href="profile.html"><img src="<?php echo URLROOT; ?>/assets_retail/images/author/pic1.png" class="rounded-circle" alt="author-image"></a>
			</div>
		</div>
	</div>
    <!-- Banner End -->
                                        ...
                                        <div class="card job-post">
                                            <div class="card-body">
                                                <div class="media media-80">
                                                    <img src="<?php echo URLROOT; ?>/assets_retail/images/logo/logo.png" alt="/">
                                                </div>
                                                <div class="card-info">
                        ...
                        <ul>
                            <li>
                                <div class="item-content">
                                    <a href="job-detail.html" class="item-media"><img src="<?php echo URLROOT; ?>/assets_retail/images/logo/company-logo1.png" width="55" alt="logo"></a>
                            ...
                            <li>
                                <div class="item-content">
                                    <a href="job-detail.html" class="item-media"><img src="<?php echo URLROOT; ?>/assets_retail/images/logo/company-logo2.png" width="55" alt="logo"></a>
                                    <div class="item-inner">
                                        <div class="item-title-row">
                            ...
                            <li>
                                <div class="item-content">
                                    <a href="job-detail.html" class="item-media"><img src="<?php echo URLROOT; ?>/assets_retail/images/logo/company-logo3.png" width="55" alt="logo"></a>
                                    <div class="item-inner">
                                        <div class="item-title-row">
                                            <div class="item-subtitle">Highspeed Studios</div>
                                            <h6 class="item-title"><a href="job-detail.html">Software Engineer</a></h6>
	...
	<div class="offcanvas offcanvas-bottom pwa-offcanvas">
		<div class="container">
			<div class="offcanvas-body small">
				<img class="logo" src="<?php echo URLROOT; ?>/assets_retail/images/icon.png" alt="">
